...
class VisualizationGenome:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            'r_const': float(self.r_const),
            'r_sqrt': float(self.r_sqrt),
            'r_lin': float(self.r_lin),
            'r_sin': float(self.r_sin),
            'r_freq': float(self.r_freq),
            't_const': float(self.t_const),
            't_sqrt': float(self.t_sqrt),
            't_lin': float(self.t_lin),
            't_mod': float(self.t_mod),
            't_mod_base': float(self.t_mod_base),
            'x_mod': float(self.x_mod),
            'x_mod_base': float(self.x_mod_base),
            'x_div': float(self.x_div),
            'x_div_base': float(self.x_div_base),
            'y_mod': float(self.y_mod),
            'y_mod_base': float(self.y_mod_base),
            'y_div': float(self.y_div),
            'y_div_base': float(self.y_div_base),
            'blend': float(self.blend),
            'x_digit_sum': float(self.x_digit_sum),
            'y_digit_sum': float(self.y_digit_sum),
            'qr_mod': float(self.qr_mod),
            'qr_base': float(self.qr_base),
